...
export default function HomePage() {
    ...
    const styleForButton = {gridColumn:2, gridRow:3, width:'60%',  justifySelf:'center'};
    return (<Box sx={styleForBox}>
        <Typography variant="h3" sx={{gridColumn:1}}>לשחק, לדעת, להצליח</Typography>
        <Typography variant="h5" sx={{gridColumn:1}}>תרגול קריאה בצורה חווייתית, ברמה וקצב מותאמים אישית, מהיום, עם מינימום מאמץ, כל אחד יכול להצליח!</Typography>
